...
const providerMeta: Record<ProviderType, { label: string; icon: React.ReactNode }> = {
  ...
  vllm: {
    label: 'vLLM',
    icon: (
      <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" style={{flex: '0 0 auto', lineHeight: 1}}><title>vLLM</title><path d="M2 6a2 2 0 012-2h16a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2V6zm0 8a2 2 0 012-2h16a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2zm4-7a1 1 0 100 2 1 1 0 000-2zm0 8a1 1 0 100 2 1 1 0 000-2zm4-8a1 1 0 100 2 1 1 0 000-2zm0 8a1 1 0 100 2 1 1 0 000-2z"/></svg>
    ),
  },
};
...
const providerRequiresApiKey = (provider: ProviderType) => provider !== 'ollama' && provider !== 'vllm';
  ...
  useEffect(() => {
    try {
      ...
      if (config.api) {
        ...
        } else if (normalizedApiBaseUrl.includes('vllm') || normalizedApiBaseUrl.includes(':8000')) {
