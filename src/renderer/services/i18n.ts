...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    webSearchTab: '联网搜索',
    webSearchTitle: '联网搜索',
    webSearchDesc: '配置联网搜索服务。AI 在对话中会自动调用搜索和抓取工具获取最新信息。',
    jinaApiKeyLabel: 'Jina AI API Key（可选）',
    jinaApiKeyPlaceholder: '留空使用免费额度，填入 Key 提升速率限制',
    jinaApiKeyHint: '免费注册：jina.ai，填入后搜索/抓取速率将大幅提升。',
    ...
    coworkEditMessage: '编辑消息',
    coworkEditMessageSend: '重新发送',
  ...
  en: {
    ...
    webSearchDesc: 'Configure web search. The AI will automatically call search and fetch tools to retrieve up-to-date information.',
    jinaApiKeyLabel: 'Jina AI API Key (optional)',
    jinaApiKeyPlaceholder: 'Leave empty for free tier, enter key to raise rate limits',
    jinaApiKeyHint: 'Free signup at jina.ai. Adding a key significantly increases rate limits.',
    ...
    coworkEditMessage: 'Edit message',
    coworkEditMessageSend: 'Resend',
