...
interface IElectronAPI {
  ...
  cowork: {
    ...
    editMessage: (options: { sessionId: string; messageId: string; newContent: string; systemPrompt?: string; activeSkillIds?: string[] }) => Promise<{ success: boolean; error?: string }>;
